...
export class BlenderCollection<T> {
    constructor(private interop: BlenderInterop, private accessor: string, private constructorFunc: Constructor<T>) { }
    ...
    public get(key: string): T {
        ...
        return new this.constructorFunc(this.interop, ref)
    }
    ...
    public values(): T[] {
        ...
        if(keys.length === 0) {
            ...
            return array.map((accessor: string) => new this.constructorFunc(this.interop, accessor))
        } else {
